classdef VideoMaker < handle
    ...
    methods
        function obj = VideoMaker(fileName, frameRate)
            % Constructor
            if nargin > 0
        ...
        function render(obj)
            ...
            % Hold the last frame for an additional 1 second (or 30 frames at 30fps)
            for i = 1:obj.FrameRate
                writeVideo(v, obj.Frames{end});
            end
            close(v);
        end
